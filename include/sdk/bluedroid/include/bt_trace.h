...
/* External declaration for appl_trace_level here to avoid to add the declaration in all the files
 * using APPL_TRACExxx macros */
...
EXPORT_API extern void BTTRC_StackTrace0( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type,
        UINT16 token );
EXPORT_API extern void BTTRC_StackTrace1( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val );
EXPORT_API extern void BTTRC_StackTrace2( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val );
EXPORT_API extern void BTTRC_StackTrace3( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
        tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val );
EXPORT_API extern void BTTRC_StackTrace4( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
        tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val, tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val );
EXPORT_API extern void BTTRC_StackTrace5( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
        tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val, tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val,
        tBTTRC_PARAM_TYPE p5_type, UINT32 p5_val );
EXPORT_API extern void BTTRC_StackTrace6( tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
        tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
        tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val, tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val,
        tBTTRC_PARAM_TYPE p5_type, UINT32 p5_val, tBTTRC_PARAM_TYPE p6_type, UINT32 p6_val );
...
#define BTTRC_STATE( lid, state ) \
    { \
        BTTRC_StackTrace1( lid, BTTRC_TYPE_EVENT, BTTRC_TOKEN_SM_STATE, BTTRC_PARAM_UINT8, \
                state ); \
    }
...
#define BTTRC_API4( lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v ) \
    { \
        BTTRC_StackTrace4( lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
                p4_v ); \
    }
#define BTTRC_API5( lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v ) \
    { \
        BTTRC_StackTrace5( lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
                p4_v, p5_t, p5_v ); \
    }
#define BTTRC_API6( lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, p6_t, \
        p6_v ) \
    { \
        BTTRC_StackTrace6( lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
...
#define BTTRC_DBG4( lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v ) \
    { \
        BTTRC_StackTrace4( lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
                p4_v ); \
    }
#define BTTRC_DBG5( lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v ) \
    { \
        BTTRC_StackTrace5( lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
                p4_v, p5_t, p5_v ); \
    }
#define BTTRC_DBG6( lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, p6_t, \
        p6_v ) \
    { \
        BTTRC_StackTrace6( lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, \
                p4_v, p5_t, p5_v, p6_t, p6_v ); \
    }
...
#define BTTRC_AVDT_SCB_DBG6( dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, \
        p6_t, p6_v ) \
    BTTRC_DBG6( BTTRC_ID_AVDT_SCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, \
            p5_v, p6_t, p6_v )
/***************************************************************************************/
/*AVDT_CCB MACROS */
...
#define BTTRC_AVDT_CCB_DBG6( dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, \
        p6_t, p6_v ) \
    BTTRC_DBG6( BTTRC_ID_AVDT_CCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v, p5_t, \
            p5_v, p6_t, p6_v )
/***************************************************************************************/
...
#define BT_ERROR_TRACE( l, ... ) \
    LogMsg( TRACE_CTRL_GENERAL | ( l ) | TRACE_ORG_STACK | TRACE_TYPE_ERROR, ##__VA_ARGS__ )
...
#define A2D_TRACE_ERROR( ... ) \
    { \
        if( a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR ) \
            BT_TRACE( TRACE_LAYER_A2D, TRACE_TYPE_ERROR, ##__VA_ARGS__ ); \
    }
#define A2D_TRACE_WARNING( ... ) \
    { \
        if( a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING ) \
            BT_TRACE( TRACE_LAYER_A2D, TRACE_TYPE_WARNING, ##__VA_ARGS__ ); \
    }
#define A2D_TRACE_EVENT( ... ) \
    { \
        if( a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT ) \
            BT_TRACE( TRACE_LAYER_A2D, TRACE_TYPE_EVENT, ##__VA_ARGS__ ); \
    }
#define A2D_TRACE_DEBUG( ... ) \
    { \
        if( a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG ) \
            BT_TRACE( TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, ##__VA_ARGS__ ); \
    }
#define A2D_TRACE_API( ... ) \
    { \
        if( a2d_cb.trace_level >= BT_TRACE_LEVEL_API ) \
            BT_TRACE( TRACE_LAYER_A2D, TRACE_TYPE_API, ##__VA_ARGS__ ); \
    }
...
#define BTIF_TRACE_ERROR( ... ) \
    { \
        if( btif_trace_level >= BT_TRACE_LEVEL_ERROR ) \
            LogMsg( TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_APPL | TRACE_TYPE_ERROR, \
                    ##__VA_ARGS__ ); \
    }
#define BTIF_TRACE_WARNING( ... ) \
    { \
        if( btif_trace_level >= BT_TRACE_LEVEL_WARNING ) \
            LogMsg( TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_APPL | TRACE_TYPE_WARNING, \
                    ##__VA_ARGS__ ); \
    }
#define BTIF_TRACE_API( ... ) \
    { \
        if( btif_trace_level >= BT_TRACE_LEVEL_API ) \
            LogMsg( TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_APPL | TRACE_TYPE_API, \
                    ##__VA_ARGS__ ); \
    }
#define BTIF_TRACE_EVENT( ... ) \
    { \
        if( btif_trace_level >= BT_TRACE_LEVEL_EVENT ) \
            LogMsg( TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_APPL | TRACE_TYPE_EVENT, \
                    ##__VA_ARGS__ ); \
    }
#define BTIF_TRACE_DEBUG( ... ) \
    { \
        if( btif_trace_level >= BT_TRACE_LEVEL_DEBUG ) \
            LogMsg( TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_APPL | TRACE_TYPE_DEBUG, \
                    ##__VA_ARGS__ ); \
    }
...
#define bdld( fmt, ... ) \
    ...
    { \
        if( ( MY_LOG_LEVEL ) >= BT_TRACE_LEVEL_DEBUG ) \
            LogMsg( ( MY_LOG_LAYER ) | TRACE_TYPE_DEBUG, "%s(L%d): " fmt, __FUNCTION__, __LINE__, \
                    ##__VA_ARGS__ ); \
    } while( 0 )
...
#define bdlw( fmt, ... ) \
    ...
    { \
        if( ( MY_LOG_LEVEL ) >= BT_TRACE_LEVEL_DEBUG ) \
            LogMsg( ( MY_LOG_LAYER ) | TRACE_TYPE_WARNING, "%s(L%d): " fmt, __FUNCTION__, \
...
#define bdle( fmt, ... ) \
    ...
    { \
        if( ( MY_LOG_LEVEL ) >= BT_TRACE_LEVEL_DEBUG ) \
            LogMsg( ( MY_LOG_LAYER ) | TRACE_TYPE_ERROR, "%s(L%d): " fmt, __FUNCTION__, __LINE__, \
                    ##__VA_ARGS__ ); \
    } while( 0 )
...
#define bdla( assert_if ) \
    ...
    { \
        if( ( ( MY_LOG_LEVEL ) >= BT_TRACE_LEVEL_ERROR ) && !( assert_if ) ) \
            LogMsg( ( MY_LOG_LAYER ) | TRACE_TYPE_ERROR, "%s(L%d): assert failed: " #assert_if, \
