...
#include "sdk/bluedroid/bta/include/bta_gatt_api.h"
#endif
...
typedef struct
{
    ...
    UINT32 role_policy_mask; /* the bits set indicates the modules that wants to remove role switch
                                from the default link policy */
