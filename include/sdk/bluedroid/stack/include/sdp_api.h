...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_InitDiscoveryDb( tSDP_DISCOVERY_DB *p_db, UINT32 len, UINT16 num_uuid,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_ServiceSearchRequest( UINT8 *p_bd_addr, tSDP_DISCOVERY_DB *p_db,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_ServiceSearchAttributeRequest( UINT8 *p_bd_addr, tSDP_DISCOVERY_DB *p_db,
        tSDP_DISC_CMPL_CB *p_cb );
...
SDP_API extern BOOLEAN SDP_ServiceSearchAttributeRequest2( UINT8 *p_bd_addr,
        tSDP_DISCOVERY_DB *p_db, tSDP_DISC_CMPL_CB2 *p_cb, void *user_data );
...
**
*******************************************************************************/
SDP_API extern tSDP_DISC_REC *SDP_FindAttributeInDb( tSDP_DISCOVERY_DB *p_db, UINT16 attr_id,
...
**
*******************************************************************************/
SDP_API extern tSDP_DISC_ATTR *SDP_FindAttributeInRec( tSDP_DISC_REC *p_rec, UINT16 attr_id );
...
**
*******************************************************************************/
SDP_API extern tSDP_DISC_REC *SDP_FindServiceInDb( tSDP_DISCOVERY_DB *p_db, UINT16 service_uuid,
        tSDP_DISC_REC *p_start_rec );
...
**
*******************************************************************************/
SDP_API extern tSDP_DISC_REC *SDP_FindServiceUUIDInDb( tSDP_DISCOVERY_DB *p_db, tBT_UUID *p_uuid,
        tSDP_DISC_REC *p_start_rec );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_FindProtocolListElemInRec( tSDP_DISC_REC *p_rec, UINT16 layer_uuid,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_FindAddProtoListsElemInRec( tSDP_DISC_REC *p_rec, UINT16 layer_uuid,
        tSDP_PROTOCOL_ELEM *p_elem );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_FindProfileVersionInRec( tSDP_DISC_REC *p_rec, UINT16 profile_uuid,
        UINT16 *p_version );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddAttribute( UINT32 handle, UINT16 attr_id, UINT8 attr_type,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddSequence( UINT32 handle, UINT16 attr_id, UINT16 num_elem,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddUuidSequence( UINT32 handle, UINT16 attr_id, UINT16 num_uuids,
        UINT16 *p_uuids );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddProfileDescriptorList( UINT32 handle, UINT16 profile_uuid,
        UINT16 version );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddLanguageBaseAttrIDList( UINT32 handle, UINT16 lang, UINT16 char_enc,
        UINT16 base_id );
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddServiceClassIdList( UINT32 handle, UINT16 num_services,
...
**
*******************************************************************************/
SDP_API extern UINT16 SDP_SetLocalDiRecord( tSDP_DI_RECORD *device_info, UINT32 *p_handle );
...
**
*******************************************************************************/
SDP_API extern UINT16 SDP_GetLocalDiRecord( tSDP_DI_GET_RECORD *p_device_info, UINT32 *p_handle );
...
**
*******************************************************************************/
SDP_API extern UINT16 SDP_DiDiscover( BD_ADDR remote_device, tSDP_DISCOVERY_DB *p_db, UINT32 len,
        tSDP_DISC_CMPL_CB *p_cb );
...
**
*******************************************************************************/
SDP_API extern UINT16 SDP_GetDiRecord( UINT8 getRecordIndex, tSDP_DI_GET_RECORD *device_info,
...
**
*******************************************************************************/
SDP_API UINT32 SDP_ConnOpen( UINT8 *p_bd_addr, tSDP_DISC_RES_CB *p_rcb, tSDP_DISC_CMPL_CB *p_cb );
