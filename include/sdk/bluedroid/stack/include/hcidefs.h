...
/*High Duty Cycl Directed ADv and Passive Scanning State combination is supported.
 * 0x0000000000000800 */
...
#define HCI_VALID_ACL_PKT_TYPE( t ) \
    ( ( ( ( ( t ) & \
                  ~( HCI_PKT_TYPES_MASK_DM1 | HCI_PKT_TYPES_MASK_DH1 | HCI_PKT_TYPES_MASK_DM3 | \
                          ...
                          HCI_PKT_TYPES_MASK_DH5 | HCI_PKT_TYPES_MASK_NO_2_DH1 | \
                          HCI_PKT_TYPES_MASK_NO_3_DH1 | HCI_PKT_TYPES_MASK_NO_2_DH3 | \
...
#define HCI_VALID_ESCO_PKT_TYPE( t ) \
    ( ( ( ( ( t ) & \
            ...
            ( ( t ) != 0 ) ) /* Packet type should be one of valid but at least one should be \
                                specified */
...
#define HCI_INQ_RESP_NOTIF_SUPPORTED( x ) \
    ( ( x )[ HCI_EXT_FEATURE_INQ_RESP_NOTIF_OFF ] & HCI_EXT_FEATURE_INQ_RESP_NOTIF_MASK )
...
#define HCI_ADD_SCO_CONN_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_ADD_SCO_CONN_OFF ] & HCI_SUPP_COMMANDS_ADD_SCO_CONN_MASK )
...
#define HCI_AUTH_REQUEST_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_AUTH_REQUEST_OFF ] & HCI_SUPP_COMMANDS_AUTH_REQUEST_MASK )
...
#define HCI_HOLD_MODE_CMD_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_HOLD_MODE_CMD_OFF ] & HCI_SUPP_COMMANDS_HOLD_MODE_CMD_MASK )
...
#define HCI_READ_PIN_TYPE_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_READ_PIN_TYPE_OFF ] & HCI_SUPP_COMMANDS_READ_PIN_TYPE_MASK )
...
#define HCI_READ_BD_ADDR_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_READ_BD_ADDR_OFF ] & HCI_SUPP_COMMANDS_READ_BD_ADDR_MASK )
...
#define HCI_READ_BD_CLOCK_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_READ_BD_CLOCK_OFF ] & HCI_SUPP_COMMANDS_READ_BD_CLOCK_MASK )
...
#define HCI_AMP_TEST_END_SUPPORTED( x ) \
    ( ( x )[ HCI_SUPP_COMMANDS_AMP_TEST_END_OFF ] & HCI_SUPP_COMMANDS_AMP_TEST_END_MASK )
