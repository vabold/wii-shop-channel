...
#define GATT_SIGN_CMD_WRITE 0xD2 /* changed in V4.0 1101-0010 (signed write)  see write cmd \
                                    above*/
...
/* Union of the event data which is used in the server respond API to carry the server response
 * information
 */
typedef union
{
...
#define GATT_LINK_IDLE_TIMEOUT_WHEN_NO_APP \
    0 /* start a idle timer for this duration \
...
typedef void(
        tGATT_DISC_RES_CB )( UINT16 conn_id, tGATT_DISC_TYPE disc_type, tGATT_DISC_RES *p_data );

/* discover complete callback function */
typedef void(
        tGATT_DISC_CMPL_CB )( UINT16 conn_id, tGATT_DISC_TYPE disc_type, tGATT_STATUS status );
...
**
*******************************************************************************/
GATT_API extern UINT16 GATTS_CreateService( tGATT_IF gatt_if, tBT_UUID *p_svc_uuid, UINT16 svc_inst,
        UINT16 num_handles, BOOLEAN is_pri );
...
**
*******************************************************************************/
GATT_API extern UINT16 GATTS_AddIncludeService( UINT16 service_handle, UINT16 include_svc_handle );
...
**
*******************************************************************************/
GATT_API extern tGATT_STATUS GATTS_HandleValueIndication( UINT16 conn_id, UINT16 attr_handle,
...
**
*******************************************************************************/
GATT_API extern tGATT_STATUS GATTS_SendRsp( UINT16 conn_id, UINT32 trans_id, tGATT_STATUS status,
        tGATTS_RSP *p_msg );
