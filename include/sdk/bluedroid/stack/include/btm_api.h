...
#define BTM_BLE_DISCOVERABLE_MASK \
    ( BTM_BLE_NON_DISCOVERABLE | BTM_BLE_LIMITED_DISCOVERABLE | BTM_BLE_GENERAL_DISCOVERABLE )
...
#define BTM_LE_GENERAL_INQUIRY_ACTIVE \
    BTM_BLE_GENERAL_INQUIRY /* a general inquiry is in progress \
                             */
#define BTM_LE_LIMITED_INQUIRY_ACTIVE \
    BTM_BLE_LIMITED_INQUIRY            /* a limited inquiry is in progress \
                                        */
...
#define BTM_BR_INQ_ACTIVE_MASK \
    ( BTM_GENERAL_INQUIRY_ACTIVE | BTM_LIMITED_INQUIRY_ACTIVE | \
            BTM_PERIODIC_INQUIRY_ACTIVE ) /* BR/EDR inquiry activity mask */
#define BTM_BLE_SCAN_ACTIVE_MASK 0xF0     /* LE scan activity mask */
#define BTM_BLE_INQ_ACTIVE_MASK \
    ( BTM_LE_GENERAL_INQUIRY_ACTIVE | BTM_LE_LIMITED_INQUIRY_ACTIVE ) /* LE inquiry activity \
                                                                         mask*/
#define BTM_INQUIRY_ACTIVE_MASK \
    ( BTM_BR_INQ_ACTIVE_MASK | BTM_BLE_INQ_ACTIVE_MASK ) /* inquiry activity mask */
...
typedef struct
{
    ...
    BOOLEAN appl_knows_rem_name; /* set by application if it knows the remote name of the peer
                                    device. This is later used by application to determine if remote
                                    name request is required to be done. Having the flag here avoid
...
typedef void( tBTM_ACL_DB_CHANGE_CB )( BD_ADDR p_bda, DEV_CLASS p_dc, BD_NAME p_bdn,
        UINT8 *features, BOOLEAN is_new, UINT16 handle, tBT_TRANSPORT transport );
#else
typedef void( tBTM_ACL_DB_CHANGE_CB )( BD_ADDR p_bda, DEV_CLASS p_dc, BD_NAME p_bdn,
...
#define BTM_SCO_LINK_ALL_PKT_MASK ( BTM_SCO_LINK_ONLY_MASK | BTM_ESCO_LINK_ONLY_MASK )
...
typedef UINT8( tBTM_AUTHORIZE_CALLBACK )( BD_ADDR bd_addr, DEV_CLASS dev_class,
        tBTM_BD_NAME bd_name, UINT8 *service_name, UINT8 service_id, BOOLEAN is_originator );
...
**              BD Name of remote
*/
typedef UINT8( tBTM_PIN_CALLBACK )( BD_ADDR bd_addr, DEV_CLASS dev_class, tBTM_BD_NAME bd_name );
...
*/
typedef UINT8( tBTM_LINK_KEY_CALLBACK )( BD_ADDR bd_addr, DEV_CLASS dev_class, tBTM_BD_NAME bd_name,
        UINT8 *key, UINT8 key_type );

/* Remote Name Resolved.  Parameters are
**              BD Address of remote
**              BD Name of remote
*/
typedef void( tBTM_RMT_NAME_CALLBACK )( BD_ADDR bd_addr, DEV_CLASS dc, tBTM_BD_NAME bd_name );
...
**
*/
typedef UINT8( tBTM_ABORT_CALLBACK )( BD_ADDR bd_addr, DEV_CLASS dev_class, tBTM_BD_NAME bd_name );
...
#define BTM_AUTH_DD_BOND \
    2 /* this bit is ORed to the BTM_AUTH_SP_* when IO exchange for dedicated bonding */
...
typedef struct
{
    ...
    UINT32 num_val; /* the numeric value for comparison. If just_works, do not show this number to
                       UI */
...
*/
typedef void( tBTM_SEC_CBACK )( BD_ADDR bd_addr, tBT_TRANSPORT trasnport, void *p_ref_data,
        tBTM_STATUS result );
...
**************************************/
typedef void( tBTM_PM_STATUS_CBACK )( BD_ADDR p_bda, tBTM_PM_STATUS status, UINT16 value,
        UINT8 hci_status );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_VendorSpecificCommand( UINT16 opcode, UINT8 param_len,
...
**
*******************************************************************************/
BTM_API extern UINT16 BTM_ReadDiscoverability( UINT16 *p_window, UINT16 *p_interval );
...
**                      max_resps - maximum amount of devices to search for before ending the
*inquiry
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetPeriodicInquiryMode( tBTM_INQ_PARMS *p_inqparms, UINT16 max_delay,
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadRemoteDeviceName( BD_ADDR remote_bda, tBTM_CMPL_CB *p_cb,
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadRemoteVersion( BD_ADDR addr, UINT8 *lmp_version,
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_StartDiscovery( tBTM_CMPL_CB *p_cmpl_cb, BD_ADDR_PTR p_rem_addr );
...
**
*******************************************************************************/
BTM_API extern tSDP_DISC_REC *BTM_FindAttribute( UINT16 attr_id, tSDP_DISC_REC *p_start_rec );
...
**
*******************************************************************************/
BTM_API extern tSDP_DISC_REC *BTM_FindService( UINT16 service_uuid, tSDP_DISC_REC *p_start_rec );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetLinkPolicy( BD_ADDR remote_bda, UINT16 *settings );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadLinkPolicy( BD_ADDR remote_bda, tBTM_CMPL_CB *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetLinkSuperTout( BD_ADDR remote_bda, UINT16 timeout );
/*******************************************************************************
**
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_GetLinkSuperTout( BD_ADDR remote_bda, UINT16 *p_timeout );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetParkMode( BD_ADDR remote_bda, UINT16 beacon_min_period,
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SwitchRole( BD_ADDR remote_bd_addr, UINT8 new_role,
        tBTM_CMPL_CB *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ChangeLinkKey( BD_ADDR remote_bd_addr, tBTM_CMPL_CB *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadTxPower( BD_ADDR remote_bda, tBT_TRANSPORT transport,
        tBTM_CMPL_CB *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetQoS( BD_ADDR bd, FLOW_SPEC *p_flow, tBTM_CMPL_CB *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_CreateSco( BD_ADDR remote_bda, BOOLEAN is_orig, UINT16 pkt_types,
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetEScoMode( tBTM_SCO_TYPE sco_mode, tBTM_ESCO_PARAMS *p_parms );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_RegForEScoEvts( UINT16 sco_inx, tBTM_ESCO_CBACK *p_esco_cback );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadEScoLinkParms( UINT16 sco_inx, tBTM_ESCO_DATA *p_parms );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ChangeEScoLinkParms( UINT16 sco_inx, tBTM_CHG_ESCO_PARAMS *p_parms );
...
**
*******************************************************************************/
BTM_API extern void BTM_EScoConnRsp( UINT16 sco_inx, UINT8 hci_status, tBTM_ESCO_PARAMS *p_parms );
...
**
*******************************************************************************/
BTM_API extern BOOLEAN BTM_GetSecurityFlagsByTransport( BD_ADDR bd_addr, UINT8 *p_sec_flags,
        tBT_TRANSPORT transport );
...
**
*******************************************************************************/
BTM_API extern BOOLEAN BTM_SetSecurityLevel( BOOLEAN is_originator, char *p_name, UINT8 service_id,
...
BTM_API extern BOOLEAN BTM_SetUCDSecurityLevel( BOOLEAN is_originator, char *p_name,
        UINT8 service_id, UINT16 sec_level, UINT16 psm, UINT32 mx_proto_id, UINT32 mx_chan_id );
...
**
*******************************************************************************/
BTM_API extern BOOLEAN BTM_SecAddDevice( BD_ADDR bd_addr, DEV_CLASS dev_class, BD_NAME bd_name,
        UINT8 *features, UINT32 trusted_mask[], LINK_KEY link_key, UINT8 key_type,
        tBTM_IO_CAP io_cap );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SecGetDeviceLinkKey( BD_ADDR bd_addr, LINK_KEY link_key );
...
**
*******************************************************************************/
BTM_API extern void BTM_PINCodeReply( BD_ADDR bd_addr, UINT8 res, UINT8 pin_len, UINT8 *p_pin,
        UINT32 trusted_mask[] );
...
**
*******************************************************************************/
BTM_API extern void BTM_DeviceAuthorized( BD_ADDR bd_addr, UINT8 res, UINT32 trusted_mask[] );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SecBond( BD_ADDR bd_addr, UINT8 pin_len, UINT8 *p_pin,
        UINT32 trusted_mask[] );
...
**
*******************************************************************************/
BTM_API extern void BTM_IoCapRsp( BD_ADDR bd_addr, tBTM_IO_CAP io_cap, tBTM_OOB_DATA oob,
...
**
*******************************************************************************/
BTM_API extern void BTM_RemoteOobDataReply( tBTM_STATUS res, BD_ADDR bd_addr, BT_OCTET16 c,
        BT_OCTET16 r );
...
**
*******************************************************************************/
BTM_API extern UINT16 BTM_BuildOobData( UINT8 *p_data, UINT16 max_len, BT_OCTET16 c, BT_OCTET16 r,
        UINT8 name_len );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_PmRegister( UINT8 mask, UINT8 *p_pm_id, tBTM_PM_STATUS_CBACK *p_cb );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadPowerMode( BD_ADDR remote_bda, tBTM_PM_MODE *p_mode );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetSsrParams( BD_ADDR remote_bda, UINT16 max_lat, UINT16 min_rmt_to,
        UINT16 min_loc_to );
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_WriteStoredLinkKey( UINT8 num_keys, BD_ADDR *bd_addr,
...
BTM_API extern tBTM_STATUS BTM_ConfigScoPath( tBTM_SCO_ROUTE_TYPE path,
        tBTM_SCO_DATA_CB *p_sco_data_cb, tBTM_SCO_PCM_PARAM *p_pcm_param, BOOLEAN err_data_rpt );
