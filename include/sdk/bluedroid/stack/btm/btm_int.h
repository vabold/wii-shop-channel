...
#include "sdk/bluedroid/stack/include/rfcdefs.h"
#endif
...
#define BTM_ACL_EXCEPTION_PKTS_MASK \
    ( HCI_PKT_TYPES_MASK_NO_2_DH1 | HCI_PKT_TYPES_MASK_NO_3_DH1 | HCI_PKT_TYPES_MASK_NO_2_DH3 | \
            HCI_PKT_TYPES_MASK_NO_3_DH3 | HCI_PKT_TYPES_MASK_NO_2_DH5 | \
            HCI_PKT_TYPES_MASK_NO_3_DH5 )

#define BTM_EPR_AVAILABLE( p ) \
    ( ( HCI_ATOMIC_ENCRYPT_SUPPORTED( ( p )->peer_lmp_features[ HCI_EXT_FEATURES_PAGE_0 ] ) && \
...
#define BTM_RE_READ_1ST_PAGE \
    0x01 /* Set it if you set at least one of "..._HOST_MAY_SUPP_..." bits */
#define BTM_HOST_MAY_SUPP_SSP 0x02
#define BTM_HOST_MAY_SUPP_LE 0x04
#define BTM_HOST_MAY_SUPP_SIMULT_BR_LE 0x08
    UINT8 lmp_features_host_may_support; /* The flags of LMP features host may support via BR/EDR
                                            ctrlr + BTM_RE_READ_1ST_PAGE */
...
#define BTM_ESCO_PKT_TYPE_MASK \
    ( HCI_ESCO_PKT_TYPES_MASK_HV1 | HCI_ESCO_PKT_TYPES_MASK_HV2 | HCI_ESCO_PKT_TYPES_MASK_HV3 )
...
extern void btm_accept_sco_link( UINT16 sco_inx, tBTM_ESCO_PARAMS *p_setup, tBTM_SCO_CB *p_conn_cb,
...
#define BTM_SEC_LE_LINK_KEY_AUTHED 0x2000
    ...
    tBTM_BD_NAME sec_bd_name; /* User friendly name of the device. (may be truncated to save space
                                 in dev_rec table) */
...
#define BTM_SM4_RETRY \
    0x02 /* set this bit to retry on HCI_ERR_KEY_MISSING or HCI_ERR_LMP_ERR_TRANS_COLLISION */
#define BTM_SM4_DD_ACP 0x20 /* set this bit to indicate peer initiated dedicated bonding */
#define BTM_SM4_CONN_PEND \
    0x40       /* set this bit to indicate accepting acl conn; to be cleared on btm_acl_created */
...
#define BTM_SEC_NO_LAST_SERVICE_ID 0
    UINT8 last_author_service_id; /* ID of last serviced authorized: Reset after each l2cap
                                     connection */
...
*******************************************
*/
extern tBTM_STATUS btm_initiate_rem_name( BD_ADDR remote_bda, tBTM_INQ_INFO *p_cur, UINT8 origin,
...
extern void btm_acl_created( BD_ADDR bda, DEV_CLASS dc, BD_NAME bdn, UINT16 hci_handle,
        UINT8 link_role, tBT_TRANSPORT transport );
...
extern void btm_cont_rswitch_or_chglinkkey( tACL_CONN *p, tBTM_SEC_DEV_REC *p_dev_rec,
        UINT8 hci_status );
...
extern void btm_esco_proc_conn_chg( UINT8 status, UINT16 handle, UINT8 tx_interval,
        UINT8 retrans_window, UINT16 rx_pkt_len, UINT16 tx_pkt_len );
...
*/
extern BOOLEAN btm_dev_support_switch( BD_ADDR bd_addr );
extern tBTM_STATUS btm_sec_l2cap_access_req( BD_ADDR bd_addr, UINT16 psm, UINT16 handle,
...
extern tBTM_STATUS btm_sec_mx_access_request( BD_ADDR bd_addr, UINT16 psm, BOOLEAN is_originator,
        UINT32 mx_proto_id, UINT32 mx_chan_id, tBTM_SEC_CALLBACK *p_callback, void *p_ref_data );
