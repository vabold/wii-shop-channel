...
#define BTM_BLE_GAP_ADV_FAST_INT_2 \
    160 /* TGAP(adv_fast_interval2) = 100(used) ~ 150 ms = 160 * 0.625 ms */
...
#define BLE_RESOLVE_ADDR_MSB \
    0x40 /*  most significant bit, bit7, bit6 is 01 to be resolvable random */
...
#define BTM_BLE_PRIVATE_ADDR_INT \
    900 /* 15 minutes minimum for \
...
extern void btm_sec_save_le_key( BD_ADDR bd_addr, tBTM_LE_KEY_TYPE key_type,
        tBTM_LE_KEY_VALUE *p_keys, BOOLEAN pass_to_application );
...
BT_API extern void btm_ble_set_test_local_sign_cntr_value( BOOLEAN enable,
